                            ...
                            if (type === "all") {
                                ...
                                return (
                                    <tr key={key} >
                                        ...
                                        <td className="diagnos ">  {connector.diagnosis} </td>
                                        <td scope="" className="fish text-center">
                                            {connector.position === "yakunlangan" ? "Xizmat" : <Link className='btn button-success' to={`/medsestra/addstatsionar/${connector._id}`}> Qo'shish</Link>}
                                        </td>
                                        <td scope="" className="cek text-center">
                                            <Link to={`/medsestra/statsionarreciept/${all && all.clients[key]._id}/${connector._id}`} > <FontAwesomeIcon icon={faPrint} className="fa-2x" /> </Link>
                                        </td>
                                    </tr>
                                )
                            } else {
